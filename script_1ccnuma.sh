...
echo -n "start $numcores $simrange : "
    srun --cpu-freq=2000000-2000000:performance likwid-pin -q -c M0:0-$numcores ./$perffile ${simrange} > procfile
...
gnuplot perf_cg_1cc.gnuplot
gnuplot perf_pcg_1cc.gnuplot
