...
set label "931.8 [MLUPS/s] no WA" at graph 0.02, first 960

set arrow from graph 0, first 854 to graph 1, first 854nohead lt 0 lw 2 lc rgb "blue"
set label "854 [MLUPS/s] with WA" at graph 0.02, first 820

plot './simdata1ccnuma/cgperf_400000' title "1000 x 400000" with linespoints, \
'./simdata1ccnuma/cgperf_20000' title "2000 x 20000" with linespoints, \
